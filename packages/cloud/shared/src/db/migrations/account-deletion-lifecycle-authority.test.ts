...
const migrationNames = [
  ...
  "0311_account_deletion_lifecycle_authority.sql",
  "0312_account_deletion_phase_receipts.sql",
  "0313_account_deletion_exports.sql",
  "0314_account_deletion_canceling_state.sql",
] as const;
